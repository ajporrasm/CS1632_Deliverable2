...
public class ProgramExecutor 
{
	...
	try 
	{
			//Want to check for end of comment first to avoid bugs
			if(c == ')')
			{
				comment = false;
				return;
			...
			//If comment is true, ignore instruction until comment is false
			if (comment == true)
			{
		      return;
		    }
	    ...
	    //increment counter feature
	    case 'i':
	          counter++;
	          break;
	    
	    //decrement counter feature
	    case 'd':
	          counter--;
	          break;
	          
	    //return counter feature
	    case 't':
	    	_ps.push(counter);
	         break;
	    
	    //reverse stack feature    
	    //made the function in program stack with the other previously featured function methods
	    case 'r':
	          _ps.reverse();
	          break;
	      
	    //begin comment feature      
	    case '(':
	          comment = true;
	          break;
	          
	    //end comment feature. I added this at the top, this is here likely unnecessarily      
	    case ')':
	          comment = false;
	          break;
